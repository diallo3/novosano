	...
	$( '.mwb_wgm_send_giftcard' ).change( function(){
		...
		if(radioVal == "Mail to recipient"){
			...
			$("#mwb_wgm_to_ship").val("");
         	...
         	$("#mwb_wgm_to_download").attr("readonly", true);
         	$("#mwb_wgm_to_ship").attr("readonly", true);
         	$("#mwb_wgm_to_download").addClass("mwb_wgm_disable");
         	$("#mwb_wgm_to_ship").addClass("mwb_wgm_disable");
         	$("#mwb_wgm_to_email").removeClass("mwb_wgm_disable");
	        ...
	        $("#mwb_wgm_to_email").attr("readonly", true);
	        $("#mwb_wgm_to_ship").attr("readonly", true);
	        $("#mwb_wgm_to_name_optional").attr("readonly", true);
	        $("#mwb_wgm_to_download").removeClass("mwb_wgm_disable");
         	$("#mwb_wgm_to_ship").addClass("mwb_wgm_disable");
         	$("#mwb_wgm_to_email").addClass("mwb_wgm_disable");
	     }
	        ...
	        $("#mwb_wgm_to_download").addClass("mwb_wgm_disable");
	        $("#mwb_wgm_to_email").addClass("mwb_wgm_disable");
	        $("#mwb_wgm_to_ship").removeClass("mwb_wgm_disable");
	     }
