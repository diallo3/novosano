		...
		<tr valign="top">
			...
			<td class="forminp forminp-text">
				<label for="mwb_wgm_other_setting_receive_message">
					<?php 
					$attribute_description = __('Write the Email Content to notify the user who send the Giftcard about that Giftcard Coupon is send to receiver.', 'woocommerce-ultimate-gift-card');
					echo wc_help_tip( $attribute_description );
					?>
					<?php 
