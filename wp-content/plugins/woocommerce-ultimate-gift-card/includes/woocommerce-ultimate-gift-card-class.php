...
if( !class_exists( 'MWB_WGM_Card_Product' ) )
{
	...
	class MWB_WGM_Card_Product{
		...
		public function __construct( ) 
		{
			...
			add_action( 'admin_menu', array ( $this, 'mwb_wgm_admin_menu' ), 10, 2 );
		...
		{
			add_submenu_page( "woocommerce", __("WooCommerce Gift Manager","woocommerce-ultimate-gift-card"), __("Gift Manager","woocommerce-ultimate-gift-card"), "manage_woocommerce", "mwb-wgc-setting", array($this, "mwb_wgm_admin_setting"));
		}
